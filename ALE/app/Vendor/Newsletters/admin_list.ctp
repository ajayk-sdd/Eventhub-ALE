                    ...
                    <?php foreach ($newsletters as $newsletter): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo $this->Html->link($this->html->image('/img/admin/delete.png'), array("controller" => "Commons", "action" => "Delete", base64_encode($newsletter['Newsletter']['id']), 'Newsletter'), array('escape' => false, 'title' => 'Delete', 'class' => "edidlt", 'onclick' => "return confirm('Are you sure you want to delete this user ?');")); ?>
                            </td>    
                        </tr>
                    <?php endforeach; ?>  
                </table><br/>
