<!--Content Wrapper Starts-->
            <section id="cont_wrapper">
                ...
                <section class="content">
                	<!--Main Heading Starts-->
                    <h1 class="main_heading"> <?php echo $this->Html->link('Add Email','/admin/Newsletters/addEmail');?></h1>
                    <!--Main Heading Ends-->
			...
			echo $this->Form->create("Newsletter", array("action"=>"addEmail","id"=>"addCmsForm"));
		     ...
		     ?>
                    	<ul class="form">
                            <li>
				<?php echo $this->Form->input("NewsletterEmail.subject",array("class"=>"validate[required] form_input","div"=>false,"label"=>"Subject :*",'id'=>"subject"));?>
                            </li>
			     <li>
