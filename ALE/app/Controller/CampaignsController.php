...
class CampaignsController extends AppController {
        ...
        if ($this->Session->check('finalArr')) {
            ...
            if (!empty($finalArr['Add'])) {
                ...
                foreach ($events as $event) {
                    ...
                    $long_description = str_replace("<p>&nbsp;</p>", "", $long_description);
                    $long_description = str_replace("<p> </p>", "", $long_description);
                    $long_description = substr($long_description,0,250);
                ...
                $new_html = $ht . "<tr style='display:none'><td>*|NEXT|*</td></tr>";
    ...
    public function configureMultipleEvent($campaign_id = NULL) {
        ...
        $data["Campaign"]["id"] = $campaign_id;
        $final = $start_html . $ht . "<tr style='display:none'><td>*|NEXT|*</td></tr>" . $end_html;
    ...
    public function chooseEventSingle($action = NULL) {
        ...
        if ($this->data) {
            ...
            $facebook_cond = array("Event.event_from" => "facebook");
            $cate_vibe = array('OR' => array($conditions_vibe, $category_condition, $facebook_cond));
    ...
    public function chooseEventMultiple($campaign_id = NULL, $action = NULL) {
        $this->layout = 'front/home';
        $this->set('title_for_layout', 'ALIST Hub :: Select Event');
        $this->loadModel("MyCalendar");
        $this->loadModel("MyWpplugin");
        $this->loadModel("Region");
        $this->loadModel("Category");
