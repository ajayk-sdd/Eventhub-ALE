...
class NewslettersController extends AppController {
    ...
    public function confirmEmail($token = NULL) {
        ...
        if ($token) {
            ...
            if (!empty($newsletter)) {
                ...
                $this->set("message", "Thanks for confirm your email.");
            } else {
    ...
    public function admin_list() {
        ...
        if ($this->data) {
            ...
            $this->paginate = array('conditions' => $conditions, 'limit' => 4, 'order' => array('Newsletter.email' => 'ASC'));
        }
    ...
    public function admin_listEmail() {
        ...
        if ($this->data) {
            ...
            $this->paginate = array('conditions' => $conditions, 'limit' => 4, 'order' => array('NewsletterEmail.subject' => 'ASC'));
        }
