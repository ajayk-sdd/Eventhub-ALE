...
class TestsController extends AppController {
    ...
    function beforeFilter() {
        parent::beforeFilter();
        $this->Auth->allow('testLogin', 'postEventsOnFacebook', 'checkmail','ckeditor','email_status','email_open_status','email_clicked_status');
    }
    ...
    public function testmail() {
        ...
        $this->Email->to = "dev12sebiz@gmail.com";
    ...
    return $res;
       ...
       /*  $email = "dev12sebiz@gmail.com";
        $data = "szdfgsdfgsdfgsdfg";
        $options = array("html" => $data, "subject" => "Account activation");
        //$response = $this->Mailgun->send_mail("dev12sebiz@gmail.com", $email, $options);
