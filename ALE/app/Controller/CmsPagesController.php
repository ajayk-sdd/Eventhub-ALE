...
class CmsPagesController extends AppController {
    ...
    function admin_add($id = NULL) {
        ...
        $cmsData = $this->CmsPage->find('list', array('conditions' => array('CmsPage.status' => 1)));
    ...
    function admin_emailList() {
        ...
        $Emaildata = $this->EmailTemplate->find('all');
    ...
    public function cmsPage($title = null) {
        ...
        $page = $this->CmsPage->find('first', array('conditions' => array('CmsPage.title' => trim($title))));
    ...
    public function admin_listBanner() {
        ...
        $this->loadModel("Banner");
        $this->paginate = array("conditions" => array(), 'limit' => 10, 'order' => "Banner.order", "fields" => array("Banner.*"));
