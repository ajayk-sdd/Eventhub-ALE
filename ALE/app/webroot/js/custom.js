...
function add_to_mycalender(event_id) {
    $('#load_' + event_id).show();
    jQuery.ajax({
    ...
    if (email == "") {
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                $('#load_newsletter_top').hide();
                if (data == 1) {
                      alert("Subscription to the ALH Newsletter successful");
                      ...
                      alert(email + "is already Subscribe for Newsletter");
                } else if (data == 4) {
                      alert("Please Enter an Email Address.");
                 } else {
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                ...
                if (data > 0) {
                    ...
                    $("#error_message").html("An error occured, please try again");
                }
            }
        });
    } else {
