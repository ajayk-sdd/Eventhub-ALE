                            ...
                            <tbody>
                              <?php if(!empty($cardData)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <?php echo $this->Html->link('Edit', array("controller" => "Users", "action" => "BillingInfo", base64_encode($data['BillingInfo']['id'])), array('escape' => false, 'title' => 'Edit', 'class' => "edidlt"));
                                       
                                        echo $this->Html->link('Delete', array("controller" => "Commons", "action" => "Delete", "Update",base64_encode($data['BillingInfo']['id']),'BillingInfo','admin'=>true), array('escape' => false, 'title' => 'Delete', 'class' => "edidlt", 'onclick' => "return confirm('Are you sure you want to delete this card ?');")); ?>
                                        </td>    
                                    </tr>
                                 <?php endforeach;
                                  }else{?>
