        ...
        <section class="content_info">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabulardata user_detail">
                ...
                <tr>
                    ...
                    <td style="border: none;"><?php echo $this->Form->input("Submit", array("type"=>"submit","label"=>false,"div"=>false,"class"=>"blu_btn_rt flt-left"))."&nbsp;&nbsp;".$this->html->link("Delete User", "javascript:void(0);",array("class"=>"blu_btn_rt"));?></td>
                </tr>
            </table>
