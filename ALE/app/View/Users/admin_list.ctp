        ...
        <section class="content_info">
	     ...
	     <div class="srch_box">
                ...
                <?php echo $this->Form->create("User", array("action" => "list", 'enctype' => 'multipart/form-data', "novalidate" => "novalidate"));
                            echo '<div>';
			    echo $this->Form->input('User.id', array('type' => 'text','label' => "Id:", 'div' => false, 'maxlength' => '50', 'autocomplete' => 'off', 'class' => 'form_input', 'placeholder' => 'Enter Id'));
			    ...
			    echo $this->Form->input('User.username', array('label' => "Username:", 'div' => false, 'maxlength' => '50', 'autocomplete' => 'off', 'class' => 'input form_input', 'placeholder' => 'Enter Username'));
                            ...
                            echo $this->Form->input('User.first_name', array('label' => "First Name:", 'div' => false, 'maxlength' => '50', 'autocomplete' => 'off', 'class' => 'form_input', 'placeholder' => 'Enter First Name'));
                            echo $this->Form->input('User.last_name', array('label' => "Last Name:", 'div' => false, 'maxlength' => '50', 'autocomplete' => 'off', 'class' => 'form_input', 'placeholder' => 'Enter Last Name'));
                            echo '</div><div><br>';
			    echo $this->Form->input("User.role_id", array('type' => 'select', 'options' => array("" => "All", "1" => "Super Admin", "2" => "Member", "3" => "Super Member", "4" => "Premium Member", "7" => "Guest"), 'div' => false, 'label' => "Show:"));
			    echo $this->Form->input("User.limit", array('type' => 'select', 'options' => array("10" => "10", "20" => "20", "50" => "50", "100" => "100"), 'div' => false, 'label' => "Show Per Page:"));
			    echo $this->Form->input("User.order", array('type' => 'select', 'options' => array("User.username" => "Username", "User.email" => "Email", "User.created" => "Date Joined"), 'div' => false, 'label' => "Order by:"));
