                ...
                <table width='60%' border="0" style="float: left;text-align:center;" cellspacing="15px" class="dashboard">
                    <tr>
                        ...
                        <td width="20%"><div class="icon"><?php
                            ...
                            ?></div></td>
                        <td width="20%"><div class="icon"><?php
                            echo $this->Html->link($this->Html->image('admin/cms.png', array('height' => '60px', 'width' => '60px'), array('alt' => "CMS", 'title' => "CMS")), array('controller' => 'CmsPages', 'action' => 'add'), array('escape' => false), false);
                            echo "<br/><b>" . $this->Html->link('CMS', array('controller' => 'CmsPages', 'action' => 'add'), array()) . '</b>';
                            ?></div></td>
                        <td width="20%"><div class="icon"><?php
