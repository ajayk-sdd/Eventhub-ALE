    ...
    <section class="content">
        ...
        <section class="content_info">
            ...
            <ul class="form">
                ...
                <li>
                    <?php echo $this->Form->input("Brand.name", array("type" => "text", "label" => "Name :*", "div" => false, "class" => "validate[required] form_input", "id" => "name")); ?>
                </li>
                <li>
                ...
                <?php } else {?>
                <li>
                    <?php echo $this->Form->input("Brand.logo", array("type" => "file", "label" => "Upload Logo", "div" => false, "class" => "validate[required] form_input", "id" => "logo")); ?>
                </li>
                <?php }?>
                <li>
                    <?php echo $this->Form->input("Brand.description", array('id' => 'description', 'type' => 'textarea', "class" => "validate[required] form_input", "div" => false, 'label' => "Description :")); ?>
                </li>
