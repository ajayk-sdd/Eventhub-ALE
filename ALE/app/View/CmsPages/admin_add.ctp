<!--Content Wrapper Starts-->
			...
			echo $this->Form->create("CmsPage", array("action"=>"add","id"=>"addCmsForm"));
		     ...
		     ?>
                    	<ul class="form">
                            <li>
				<?php echo $this->Form->input("title",array("class"=>"validate[required] form_input","div"=>false,"label"=>"Title :*",'id'=>"cmsTitle"));?>
                            </li>
			     <li>
				<?php echo $this->Form->input("slug",array("class"=>"validate[required] form_input","div"=>false,"label"=>"Slug :*",'id'=>"cmsSlug"));?>
                            </li>
			     <li>
				<section class="select_new">
				    ...
				    <?php
                                    ...
                                    ksort($cmsData);
                                    //pr($cmsData);die;
				    echo $this->Form->input("parent", array("type"=>"select", "options"=>$cmsData,"class"=>"","div"=>false,"label"=>"Parent :"));?>
				</section>
                            </li>
