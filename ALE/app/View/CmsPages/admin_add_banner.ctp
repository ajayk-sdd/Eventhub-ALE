    ...
    <section class="content">
        ...
        <section class="content_info">
            ...
            <ul class="form">
                ...
                <li>
                    <?php
                    $options = array("728*90" => "728*90", "234*60" => "234*60", "180*150" => "180*150", "120*600" => "120*600", "336*280" => "336*280", "300*250" => "300*250", "1200*250" => "1200*250");
...
<?php echo $this->Form->input("BannerImage.to_brand.", array("type" => "select", "div" => false, "label" => "To (User/Brand) :*", "class" => "validate[required] form_input", "id" => "type", "options" => $users)); ?>
                                ...
                                <li class="bnr_det">
<?php echo $this->Form->input("BannerImage.url.", array("type" => "text", "div" => false, "label" => "URL For Link :*", "class" => "validate[required] form_input", "id" => "url")); ?>
                                </li>
...
<?php echo $this->Form->input('BannerImage.is_show.', array('id' => 'is_show', "class" => "is_show", 'generated' => false, 'type' => 'radio', 'legend' => false, 'div' => false, 'label' => false, 'options' => array('0' => '&nbsp;&nbsp;Permanently' . "&nbsp;&nbsp;", '1' => '&nbsp;&nbsp;Selected Date Range'))); ?>
                                ...
                                <li class = "showCal" style="display:none;" class="bnr_det">
                                    <label></label>
                                    <?php echo $this->Form->input("BannerImage.start_date.", array("type" => "text", "div" => false, "label" => FALSE, "class" => "validate[required] form_input", "id" => "start_date", "placeholder" => "Start Date", "class" => "start_date form_input")); ?>
<?php echo $this->Form->input("BannerImage.end_date.", array("type" => "text", "div" => false, "label" => FALSE, "class" => "validate[required] form_input", "id" => "end_date", "placeholder" => "End Date", "class" => "end_date form_input")); ?>
                                </li>
