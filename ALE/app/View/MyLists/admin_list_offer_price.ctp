                        ...
                        <?php foreach ($offer_prices as $offer_price): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php echo $this->Html->link($this->html->image('/img/admin/delete.png'), array("controller" => "Commons", "action" => "Delete", base64_encode($offer_price['OfferPrice']['id']), 'OfferPrice'), array('escape' => false, 'title' => 'Delete', 'class' => "edidlt", 'onclick' => "return confirm('Are you sure you want to delete this OfferPrice ?');")); ?>
