...
echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
        ...
        <div class="search-panel">
            ...
            <div id="dateError" style="display: none;text-align: center">You need to fill the search critaria.</div>
            <div class="sp-inner">
...
<!--                        <th>Status</th>-->
                ...
                <tbody>
                    <?php foreach ($list_emails as $listemail) { ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                echo $this->html->link('View', array('controller' => 'MyLists', 'action' => 'userDetail', base64_encode($listdetail["MyList"]["id"]), base64_encode($listemail["ListEmail"]["id"])));
                                echo $this->html->link('Edit', array('controller' => 'MyLists', 'action' => 'listuserDetail', base64_encode($listdetail["MyList"]["id"]), base64_encode($listemail["ListEmail"]["id"])));
                                echo $this->html->link("Delete", array("controller" => "admin/Commons", "action" => "Delete", base64_encode($listemail["ListEmail"]["id"]), 'ListEmail'), array('escape' => false, 'title' => 'Delete', 'class' => "", "onclick" => "javascript:return confirm('Are you sure you want to delete this Email-Id?');"));
                                ?> 
                            </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            var ListEmailEmail = $('#ListEmailEmail').val();
            if(ListEmailEmail=="")
            {
               $("#dateError").show();
