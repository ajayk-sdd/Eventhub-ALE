    ...
    <section class="content">
		...
		?>
			...
			<?php }
				...
				<?php echo $this->Html->link($this->html->image('/img/admin/view.png'), array("controller" => "MyLists", "action" => "listView", base64_encode($mylist['MyList']['id'])), array('escape' => false, 'title' => 'ListView', 'class' => "edidlt")); ?>
