    ...
    <section class="content">
        ...
        <section class="content_info">
            ...
            <ul class="form">
                ...
                <li>
                    <?php echo $this->Form->input("OfferPrice.dedicated_email_to_send", array("type" => "text", "label" => "Dedicated Email To Send:*", "div" => false, "class" => "validate[required] form_input", "id" => "specify")); ?>
                </li>
                <li>
                    <?php echo $this->Form->input("OfferPrice.multi_event_to_send", array("type" => "text", "label" => "Multi Event To Send:*", "div" => false, "class" => "validate[required] form_input")); ?>
                </li>
                <li>
                    <?php echo $this->Form->input("OfferPrice.ticket_offered_for_trade", array("type" => "text", "label" => "Ticket Offered For Trade:*", "div" => false, "class" => "validate[required] form_input")); ?>
                </li>
