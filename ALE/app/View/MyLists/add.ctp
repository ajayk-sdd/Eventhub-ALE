<section class="inner-content">
    <div class="center-block">
        <div class="repo-list-wrap width100">
		 ...
		 if(!empty($this->data['MyList']['from_email']))
		   {
			$email = $this->data['MyList']['from_email'];	
		   }
		 else
		   {
			$email = $userDetail['email'];
		   }
		 if(!empty($this->data['MyList']['from_name']))
		   {
			$name = $this->data['MyList']['from_name'];	
		   }
		 else
		   {
			$name = $userDetail['first_name'].' '.$userDetail['last_name'];
                ...
                ?>
                    ...
                    <dt>List Name:* </dt>
                    <dd><?php echo $this->Form->input("MyList.list_name", array("type" => "text", "label" => false, "div" => false, "class" => "validate[required,maxSize[40]] form_input", "maxlength" => "40")); ?></dd>
                    
                    <dt>Default From Email:* </dt>
                    <dd><?php echo $this->Form->input("MyList.from_email", array("type" => "text", "label" => false, "div" => false, "class" => "validate[required,custom[email],maxSize[50]] form_input", "value" => $email, "maxlength" => "50")); ?></dd>
                    
                    <dt>Default From Name:* </dt>
                    <dd><?php echo $this->Form->input("MyList.from_name", array("type" => "text", "label" => false, "div" => false, "class" => "validate[required,maxSize[40]] form_input", "value" => $name, "maxlength" => "40")); ?></dd>
                    ...
                    <dd><?php echo $this->Form->input("MyList.remind_me", array("type" => "textarea","rows"=>6,"cols"=>104, "label" => false, "div" => false,'placeholder'=>'Write a short reminder about how the recipient joined your list.', "class" => "validate[required,maxSize[200]] form_input", "maxlength" => "200")); ?></dd>
                   ...
                   echo $this->Form->input("MyList.contact_information", array("type" => "textarea","rows"=>6,"cols"=>104, "label" => false, "div" => false, "class" => "validate[required,maxSize[200]] form_input","value"=>"$addr", "maxlength" => "200")); ?></div></dd>
