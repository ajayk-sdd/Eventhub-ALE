    ...
    <section class="nav_container">
        <ul class="nav_links">
           ...
           <?php /* ?> 
            ...
            <li>
                <?php //echo $this->Html->link('Permission', '/admin/acl'); ?>
                <?php
                //pr($this->params);die;
                if ($this->params['controller'] == "acos") {
                    echo $this->Html->link('Permission', array('/admin/acl'), array('class' => 'active'));
                } else {
                    echo $this->Html->link('Permission', '/admin/acl');
                }
                ?> 
                <!-- <ul class="sublinks">
            ...
            <li>
                <?php //echo $this->Html->link('Role', '/admin/Users/roleList'); ?>
                <?php
                //pr($this->params);die;
                if (($this->params['action'] == "admin_roleList") && ($this->params['controller'] == "Users" || $this->params['controller'] == "users")) {
                    echo $this->Html->link("Role", array("controller" => "Users", "action" => "roleList", 'plugin' => false), array('escape' => false, 'class' => "active"));
                } else {
                    echo $this->Html->link("Role", array("controller" => "Users", "action" => "roleList", 'plugin' => false), array('escape' => false, 'class' => ""));
                }
                ?> 
                <!-- <ul class="sublinks">
                    <li><a href="#">Dummy 1</a></li>
            ...
            <li>
                <?php //echo $this->Html->link('Users', '/admin/Users/list'); ?>
                <?php
                //pr($this->params);die;
                if (($this->params['action'] == "admin_list") && ($this->params['controller'] == "Users" || $this->params['controller'] == "users")) {
                    echo $this->Html->link("Users", array("controller" => "Users", "action" => "list", 'plugin' => false), array('escape' => false, 'class' => "active"));
                } else {
                    echo $this->Html->link("Users", array("controller" => "Users", "action" => "list", 'plugin' => false), array('escape' => false, 'class' => ""));
                }
                ?> 
                <!-- <ul class="sublinks">
                    <li><a href="#">Dummy 1</a></li>
            ...
            <li>
                <?php //echo $this->Html->link('CmsPages', '/admin/CmsPages/add'); ?>
                <?php
                //pr($this->params);die;
                if (($this->params['action'] == "admin_list" || $this->params['action'] == "admin_add") && ($this->params['controller'] == "CmsPages")) {
                    echo $this->Html->link("CmsPages", array("controller" => "CmsPages", "action" => "list", 'plugin' => false), array('escape' => false, 'class' => "active"));
                } else {
                    echo $this->Html->link("CmsPages", array("controller" => "CmsPages", "action" => "list", 'plugin' => false), array('escape' => false, 'class' => ""));
                }
                ?> 
                <!-- <ul class="sublinks">
                    <li><a href="#">Dummy 1</a></li>
            ...
            <li>
                ...
                <?php
                //pr($this->params);die;
                if (($this->params['action'] == "admin_emailList" || $this->params['action'] == "admin_addEmailList") && ($this->params['controller'] == "CmsPages")) {
                    echo $this->Html->link("Email Template", array("controller" => "CmsPages", "action" => "emailList", 'plugin' => false), array('escape' => false, 'class' => "active"));
                } else {
                    echo $this->Html->link("Email Template", array("controller" => "CmsPages", "action" => "emailList", 'plugin' => false), array('escape' => false, 'class' => ""));
                }
                ?> 
                <!-- <ul class="sublinks">
                    <li><a href="#">Dummy 1</a></li>
            ...
            <li>
<?php echo $this->Html->link("Vibes", array("controller" => "Categories", "action" => "listVibes", 'plugin' => false), array('escape' => false)); ?>

            </li>
            <li>
                <?php echo $this->Html->link("Categories", array("controller" => "Categories", "action" => "list", 'plugin' => false), array('escape' => false)); ?>

            </li>
            <li>
                <?php //echo $this->Html->link("Services", array("controller" => "Services", "action" => "add", 'plugin' => false), array('escape' => false)); ?>

            </li>
            <li>
                <?php
                //pr($this->params);die;
                if (($this->params['action'] == "list" || $this->params['action'] == "createEvent") && ($this->params['controller'] == "Events")) {
                    echo $this->Html->link("Events", array("controller" => "Events", "action" => "list", 'plugin' => false), array('escape' => false, 'class' => "active"));
                } else {
                    echo $this->Html->link("Events", array("controller" => "Events", "action" => "list", 'plugin' => false), array('escape' => false, 'class' => ""));
                }
                ?> 
            </li>
        </ul><?php */ ?>
