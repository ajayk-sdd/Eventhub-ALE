                ...
                <div class="inner_modal">
                    ...
                    <ul class="form_login form-signup-logn">
                        ...
                        <li>
                            ...
                            <?php echo $this->Form->input("User.username", array("type" => "text", "label" => false, "div" => false, "class" => "validate[required] text-input", "id" => "username", "pattern" => ".{4,16}", "title" => "4-16 characters", "maxlength" => "16")); ?>
