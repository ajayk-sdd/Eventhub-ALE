                                    ...
                                    <?php foreach ($sales as $data): ?>
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                ?></td>
                                            <td>
                                                <?php $url = "http://" . $_SERVER["HTTP_HOST"] . "/Sales/invoice/" . base64_encode($data['Payment']['id']); ?>
                                                <a href="javascript:void(0);" onclick="javascript:openWindow('<?php echo $url; ?>');">Invoice</a> 
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
