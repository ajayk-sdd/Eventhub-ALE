<section id="cont_wrapper">
    ...
    <?php echo $this->Html->link($this->html->image('/img/admin/view.png'), array("controller" => "Templates", "action" => "view", base64_encode($template['EventTemplate']['id'])), array('escape' => false, 'title' => 'View', 'class' => "edidlt")); ?>
                        <?php echo $this->Html->link($this->html->image('/img/admin/delete.png'), array("controller" => "Commons", "action" => "Delete", base64_encode($template['EventTemplate']['id']), 'EventTemplate'), array('escape' => false, 'title' => 'Delete', 'class' => "edidlt", 'onclick' => "return confirm('Are you sure you want to delete this event ?');")); ?>
                            </td>    
                        </tr>
                <?php endforeach; ?>  
                </table><br/>
