...
<section id="cont_wrapper">
    ...
    <section class="content">
        ...
        <section class="content_info">
            ...
            <ul class="form">
                <li>
                    <?php echo $this->Form->input("EventTemplate.name", array("class" => "validate[required] form_input", "div" => false, "label" => "Name :*")); ?>
                </li>
                <?php if ($this->data) { ?>
                    <li>
                    ...
                    <li>
                        <?php echo $this->Form->input("EventTemplate.image", array('class' => 'form_input', 'type' => 'file', "div" => false, 'label' => "Image :")); ?>
                    </li>
                <?php } else { ?>
                    <li>
                        <?php echo $this->Form->input("EventTemplate.image", array('class' => 'validate[required] form_input', 'type' => 'file', "div" => false, 'label' => "Image :")); ?>
                    </li>
                <?php } ?>
                <li>
                ...
                <li>
                    <section class="select_new">
                        ...
                        <?php
                        $status = array("0" => "Email Template", "1" => "Single Event", "2"=>"Multiple Event");
