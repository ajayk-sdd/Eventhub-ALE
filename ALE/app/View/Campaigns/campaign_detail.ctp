            ...
            <div class="breadcrumb">
                 <ul>
                  ...
                  else
                  {
                    ...
                    <a href="/Campaigns/designTemplate/<?php echo base64_encode($campign_id);?>"><li>Step 2: Design</li></a>
                ...
                <div class="emsi-part em-pa-lt">
                    ...
                    <div style="border: 1px solid #DFDFDF;padding: 30px;">
                        <div id="mylistdiv" <?php if($listMode!="mylistdiv"){ echo 'style="display: none;"'; } ?>>
                            ...
                            $ListAttributes = array('legend' => false, 'label' => 'asd', 'id' => 'radio', 'class' => 'validate[required] email_list', "value" => $listIdMail);
                        ...
                        <div id="segmentid" <?php if($listMode!="segmentid"){ echo 'style="display: none;"'; } ?>>
                            ...
                            if (isset($segments) && !empty($segments)) {
                                ...
                                $ListAttributes = array('legend' => false, 'label' => 'asd', 'id' => 'radios', 'class' => 'validate[required] email_segment', "value" => $segmntId);
...
<script>
    ...
    function radiochoose(){
           ...
           if ($('#radiochooseSegmentid').is(':checked')) {
                ...
                $("#segmentid").hide();
                $("#mylistdiv").show();
                $(".email_segment").prop( "checked", false );
            }
        }
</script>