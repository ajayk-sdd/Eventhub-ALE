        ...
        <div class="em-sec">
            ...
            <?php if (isset($event) && !empty($event)) { ?>
                ...
                <div class="mo-sec-inner previewcampaign-whole">
                    ...
                    <div class="previewinner-sbmt-btn">
                        <?php echo $this->Html->link("Change", $urlTab1 . "/" . base64_encode($campaign["Campaign"]["id"]), array("class" => "violet_button")); ?>
                    </div>
                </div>
            ...
            <?php
            if ($campaign["Campaign"]["send_mode"] == 1) {
                $text = "Scheduled to send";
            } else {
                $text = "Sending Now";
            }
            ?>
            <div class="previewcampgn-inner mo-sec-inner previewcampaign-whole">
            ...
            <div class="clear"></div>
            <?php
            echo $this->Form->create("Campaign", array("action" => "previewCampaign", "class" => "event-form", "id" => "payment_form"));
            echo $this->Form->input("Campaign.id", array("type" => "hidden", "value" => $campaign_id));
            ?>
            <div class="previewinner-sbmt-btn">
                <?php
                echo $this->Form->input("Confirm", array("type" => "submit", "label" => false, "class" => "violet_button", "style" => "float:right;margin-right:0px;"));
                ?>
