        ...
        <div class="sp-inner">
            <ul class="sp-hide-content <?php echo $clss; ?>" >
                ...
                <li>
                    ...
                    ?></p>
                    <?php echo $this->Html->link("Change Location", 'javascript:void(0);', array("class"=>"show-more-location","id"=>"btn_zipfilter")); ?>
                    ...
                    <div class="location-more-option">
                        ...
                        <div class="search_events box-location"><?php echo $this->Form->input("Event.zip", array('type' => 'text', 'div' => false, 'label' => false, "placeholder" => "Change location, enter zip.", "maxlength" => 6)); ?>
                            ...
                            <?php echo $this->Form->input("", array('type' => 'submit', 'div' => false, 'label' => false, "onclick" => "javascript:document.search_form.submit();", "class" => "search_button", "style" => "background-color:#ccc;")); ?>
                        </div>
