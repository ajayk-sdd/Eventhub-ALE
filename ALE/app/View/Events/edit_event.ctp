...
<script>
 ...
 <!-------------- End Date Time Code ----------------->
                    ...
                    <table class="priceClass">	
                        <tr><td>
                                <label><strong>Ticket Price</strong><span class="red-star">*</span></label>
                            </td></tr>
...
<?php echo $this->Form->input("Event.video", array("placeholder" => "The URL for your event video (optional)", "type" => "text", "label" => FALSE, "div" => false, "class" => "txtbx-bg", "id" => "video_url")); ?>
                    ...
                    <div class="img-upload-box_new">
                        ...
                        ?>
                        <label>This image will be displayed on all public calendar pages, and is recommended to be 500 X 400</label>
                    </div>
                    <div class="img-upload-box_new">
...
<script>
    ...
    $("#EventEventAddress1").val(full_address);
            ...
            $("#formatted_address").html(full_address + ", " + city + ", " + state + ", " + country + "<br>" + name);
    }
