        ...
        <div class="em-sec">
            ...
            <div class="em-sec-inner">
                ...
                <div class="emsi-part em-pa-lt">
                    <label><strong>Title</strong> <span>(30 characters or less)</span><span class="red-star">*</span></label>
                    <?php echo $this->Form->input("title", array("type" => "text", "label" => FALSE, "div" => false, "class" => "txtbx-bg validate[required] ", "id" => "title", 'placeholder' => 'The Title of your event', 'maxLength' => '30')); ?>
                    <br> <br>
                            ...
                            <div id = "final_result" class = "<?php echo $final_result; ?>">
                                <span id = "formatted_address" style="color:#7900A0;">
                                    ...
                                    if (isset($this->data["Event"]["event_address"]) && !empty($this->data["Event"]["event_address"])) {
                                        ...
                                        $add1 = $address['0'];
                                        $add2 = $address['1'];
                                        echo $add2 . "<br>" . $this->data["Event"]["cant_find_city"] . "," . $this->data["Event"]["cant_find_state"]."<br>".$this->data["Event"]["cant_find_zip_code"];
                                    }
                                    ?>
                                </span><br/>
...
<div id="tabs">
    <div class="step1">
        ...
        <div style="margin-left: 31px;" class="entry">
            <br>Start Time: <input type="text" value="8:00" placeholder="8:00" class="starttimepick" id="start_timeN" name="start_timeN">&nbsp;<select class="starttimepick" name="start_timeM" id="start_timeM"><option value="am">am</option><option value="pm">pm</option></select>&nbsp;&nbsp;&nbsp;&nbsp;
            End Time: <input type="text" placeholder="8:00" class="starttimepick" id="end_timeN" name="end_timeN">&nbsp;<select class="starttimepick" name="end_timeM" id="end_timeM"><option value="am">am</option><option value="pm">pm</option></select>
        </div>
    </div>
     <div class="step2">
        <h3>
...
<script>
 ...
 <!-------------- End Date Time Code ----------------->
                        ...
                        <table class="priceClass">	
                            ...
                            <tr id="ticket-price" class="tckt-price"> 
                                ...
                                <td> 
                                    ...
                                    <a href="javascript:void(0);" class="img-prc-rmv"><img src='/app/webroot/img/admin/delete.png' alt='delete' title='Remove this set' class="img"/></a>
                                </td>
                            </tr>

                        </table>
                        <div style="display:block;" id="addPrice">

                            <?php echo $this->Html->link("+Add more", "javascript:void(0);", array('class' => 'add-more-tt', 'escape' => false, 'id' => 'add_more_price', 'id' => 'add_more_price')); ?>
                        </div>
                    <?php } else {
                        ?>
                        <table class="priceClass">	
                    ...
                    <div class="img-upload-box_new">
                        ...
                        if (isset($this->data["Event"]["id"])) {
                            echo $this->Form->input("Event.image_name", array("type" => "file", "label" => FALSE, "div" => false, "class" => "", "id" => "image_name"));
                        } else {
                            echo $this->Form->input("Event.image_name", array("type" => "file", "label" => FALSE, "div" => false, "class" => "validate[required]", "id" => "image_name"));
                        }
                        ?>
                    ...
                    <div class="img-upload-box_new">
                        ...
                        if (isset($this->data["Event"]["id"])) {
                            echo $this->Form->input("flyer_image", array("type" => "file", "label" => FALSE, "div" => false, "class" => "", "id" => "flyer_image"));
                        } else {
                            echo $this->Form->input("flyer_image", array("type" => "file", "label" => FALSE, "div" => false, "class" => "validate[required]", "id" => "flyer_image"));
                        }
                        ?>
                    </div>
                    <div class="clear"></div>
                    ...
                    <div class="img-upload-box_new">
                        ...
                        <?php echo $this->Form->input("EventImage.image_name.", array("type" => "file", "label" => FALSE, "div" => false, "class" => "", "multiple" => true)); ?>
                    </div>
                    *Please press CTRL to upload more than 1 secondary image at a time.
                    ...
                    <label>
                        ...
                        <div id="allow_users" style="display:block;" class="allow-user">
                            ...
                            <p>Enter other users' email addresses, separated by a comma.  If the user does not have an A List Hub Account, they will be asked to create one before being able to edit this event:</p>
                ...
                <div class="emsi-part em-pa-rt">
                    ...
                    <?php echo $this->Form->input("short_description", array("type" => "textarea", "label" => FALSE, "div" => false, "class" => "txtarea-sh", "id" => "short_description")); ?>
                    <span class="error" style="color:red;display:none;">Description Content exceeds the limit</span>
                    ...
                    <?php echo $this->Form->input("description", array("type" => "textarea", "label" => FALSE, "div" => false, "class" => "txtarea-lo", "id" => "description")); ?>
                    <span class="error_big" style="color:red;display:none;">Description Content exceeds the limit</span>
                    <br> <br>
                    <?php
                    $j = 0;
...
//                        endforeach;
                        ...
                        <?php
                        echo "<br>" . $this->Form->input("EventCategory.0", array("type" => "select", "label" => FALSE, "div" => FALSE, "options" => $categories, "empty" => "Select Category", "class" => "sltbx-sm validate[required]"));
                        echo "<br>" . $this->Form->input("EventCategory.1", array("type" => "select", "label" => FALSE, "div" => FALSE, "options" => $categories, "empty" => "Select Category", "class" => "sltbx-sm"));
                        echo "<br>" . $this->Form->input("EventCategory.2", array("type" => "select", "label" => FALSE, "div" => FALSE, "options" => $categories, "empty" => "Select Category", "class" => "sltbx-sm"));
                        ?>
                    </div>
                    <?php
                    $i = 0;
...
//                        endforeach;
                        ...
                        <?php
                        echo "<br>" . $this->Form->input("EventVibe.0", array("type" => "select", "label" => FALSE, "div" => FALSE, "options" => $vibes, "empty" => "Select Vibe", "class" => "sltbx-sm validate[required]"));
                        echo "<br>" . $this->Form->input("EventVibe.1", array("type" => "select", "label" => FALSE, "div" => FALSE, "options" => $vibes, "empty" => "Select Vibe", "class" => "sltbx-sm"));
                        echo "<br>" . $this->Form->input("EventVibe.2", array("type" => "select", "label" => FALSE, "div" => FALSE, "options" => $vibes, "empty" => "Select Vibe", "class" => "sltbx-sm"));
                        ?>
                    </div>
                    <div class = "location">
...
<script>
    ...
    function getDetail(name, full_address, city, state, country, lat, lng) {
        $("#EventEventAddress1").val(full_address);
        $("#EventEventAddress2").val(name);
        state = $.trim(state);
